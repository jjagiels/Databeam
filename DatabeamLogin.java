 ...
 */
public class DatabeamLogin extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String[] CREDENTIALS = new String[]{
            "mmott@udel.edu:12345", "bar@example.com:world"
    };
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_databeam_login);
...
//        Button musernameRegisterButton = (Button) findViewById(R.id.email_sign_in_button);
//        musernamesignInButton.setOnClickListener(new OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                attemptLogin();
...
//        });
    ...
    private void addusernamesToAutoComplete(List<String> usernameCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(DatabeamLogin.this,
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            String newCredential = mUsername + ":" + mPassword;
            CREDENTIALS[CREDENTIALS.length - 1] = newCredential;
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                startActivity(new Intent(DatabeamLogin.this, DatabeamMain.class));
                finish();
            } else {
